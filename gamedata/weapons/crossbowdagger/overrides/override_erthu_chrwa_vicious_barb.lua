...
function DamageEnemyRoutine(sourceObject, id)
	...
	isStillStuck = sourceObject.IsBoltStuck()
	...
	StuckToEnemy.DoHit(nil, mathf.RoundToInt(player.PrimaryDamage.GetValueFloat() * RangedDamageMultipler), damageType.PLAYER_SECONDARY_NO_KNOCKBACK, vector3.zero)
